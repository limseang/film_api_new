        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12 col-lg-8 p-10">
              ...
              <form action="{{route('tag.store')}}" method="post" class="needs-validation" novalidate>
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="type" value="{{old('type')}}" id="type" placeholder="Enter type" required>
                  <span class="invalid-feedback">
                    The field is required.
                  </span>
                </div>
