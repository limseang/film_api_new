...
{{__('sma.tag')}}
@endsection
@if(authorize('can create tag'))
    @section('breadcrumb-topbar')
    <a href="{{route('tag.create')}}" data-toggle="tooltip" role="button" type="button" aria-haspopup="true" class="d-flex align-items-center text-body">
