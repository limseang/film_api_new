...
{{__('sma.distributor')}}
@endsection
@if(authorize('can create distributor'))
    @section('breadcrumb-topbar')
    <a href="{{route('distributor.create')}}" data-toggle="tooltip" role="button" type="button" aria-haspopup="true" class="d-flex align-items-center text-body">
