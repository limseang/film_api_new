<div class="d-inline-flex"> 
    @if(authorize('can view detail cinema branch'))
        ...
        &nbsp;
    @endif
    @if(authorize('can change status cinema branch'))
        ...
        &nbsp;
    @endif
    @if(authorize('can edit cinema branch'))
        ...
        &nbsp;
    @endif
    @if(authorize('can delete cinema branch'))
