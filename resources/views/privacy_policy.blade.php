...
<div class="container">
    ...
    <section>
        ...
        <ul>
            ...
            <li><strong>Application:</strong> Refers to Film Library, the software program provided by the Company.</li>
            <li><strong>Company:</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Film Library.</li>
        ...
        <ul>
            <li><strong>With Service Providers:</strong> We may share Your personal information with Service Providers to monitor and analyze the use of our Service, to contact You.
                ...
                <section>
                    ...
                    <ul>
                        <li>By email: <a href="mailto:popcornkhmer@gmail.com">popcornkhmer@gmail.com</a></li>
                        <li>By phone number: <a href="tel:+85593410672">+85593410672</a></li>
                    </ul>
                </section>
</div>
</body>
