<div class="d-inline-flex">
    @if(authorize('can change status type'))
        ...
        &nbsp;
    @endif
    @if(authorize('can edit type'))
        <a href="{{route('type.edit', $table->id)}}" class="text-success">
