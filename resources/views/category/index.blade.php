...
{{__('sma.category')}}
@endsection
@if(authorize('can create category'))
    @section('breadcrumb-topbar')
    <a href="{{route('category.create')}}" data-toggle="tooltip" role="button" type="button" aria-haspopup="true" class="d-flex align-items-center text-body">
