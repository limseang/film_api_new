...
{{__('sma.genre')}}
@endsection
@if(authorize('can create genre'))
    @section('breadcrumb-topbar')
    <a href="{{route('genre.create')}}" data-toggle="tooltip" role="button" type="button" aria-haspopup="true" class="d-flex align-items-center text-body">
