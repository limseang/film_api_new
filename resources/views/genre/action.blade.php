<div class="d-inline-flex">
    @if(authorize('can change status genre'))
        ...
        &nbsp;
    @endif
    @if(authorize('can edit genre'))
        <a href="{{route('genre.edit', $table->id)}}" class="text-success">
