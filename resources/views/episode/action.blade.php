<div class="d-inline-flex"> 
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-end">
            @if(authorize('can add episode subtitle film'))
            ...
            @endif
            @if(authorize('can edit episode subtitle film'))
            ...
            @endif
            @if(authorize('can change status episode film'))
            ...
            @endif
            @if(authorize('can edit episode film'))
            ...
            @endif
            @if(authorize('can delete episode film'))
