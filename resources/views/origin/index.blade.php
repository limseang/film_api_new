...
{{__('sma.origin')}}
@endsection
@if(authorize('can create origin'))
    @section('breadcrumb-topbar')
    <a href="{{route('origin.create')}}" data-toggle="tooltip" role="button" type="button" aria-haspopup="true" class="d-flex align-items-center text-body">
