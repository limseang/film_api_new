...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="{{URL::asset('assets/imgs/logo_icon.png')}}">

        <meta name="description" content="@lang('global.meta_description')">
        <meta name="keywords" content="@lang('global.meta_keywords')">
        <meta name="author" content="Taing Sotheara">
