...
{{__('sma.show_episode')}}
@endsection
@if(authorize('can add episode film'))
    @section('breadcrumb-topbar')
    <a href="{{route('episode.create', $film_id)}}" data-toggle="tooltip" role="button" type="button" aria-haspopup="true" class="d-flex align-items-center text-body">
