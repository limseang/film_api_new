...
{{--                                            <input type="email" class="form-control" id="email" name="email"  value="popcorn@gmail.com" placeholder="cinemagickh@gmail.com">--}}
{{--                                        </div>--}}
{{--                                        <div class="col-12">--}}
{{--                                            <label for="password" class="form-label">Password</label>--}}
{{--                                            <div class="input-group" id="show_hide_password">--}}
{{--                                                <input type="password" class="form-control border-end-0" id="password" name="password" value="seang123" placeholder="Enter Password"> <a href="javascript:;" class="input-group-text bg-transparent"><i class="bx bx-hide"></i></a>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                        <div class="col-md-6">--}}
