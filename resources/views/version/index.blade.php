...
{{__('sma.version')}}
@endsection
@if(authorize('can create version'))
    @section('breadcrumb-topbar')
    <a href="{{route('version.create')}}" data-toggle="tooltip" role="button" type="button" aria-haspopup="true" class="d-flex align-items-center text-body">
