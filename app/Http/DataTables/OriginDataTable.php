...
class OriginDataTable extends DataTable
{
    ...
    {
        if(authorize(RolePermissionConstant::PERMISSION_ORIGIN_EDIT) || authorize(RolePermissionConstant::PERMISSION_ORIGIN_DELETE) || authorize(RolePermissionConstant::PERMISSION_ORIGIN_CHANGE_STATUS)){
