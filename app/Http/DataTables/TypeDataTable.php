...
class TypeDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($table) {
                return view('type.action', ['table' => $table]);
            })
    ...
    {
        if(authorize(RolePermissionConstant::PERMISSION_TYPE_EDIT) || authorize(RolePermissionConstant::PERMISSION_TYPE_DELETE) || authorize(RolePermissionConstant::PERMISSION_TYPE_CHANGE_STATUS)){
