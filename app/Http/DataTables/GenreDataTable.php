...
class GenreDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($table) {
                return view('genre.action', ['table' => $table]);
            })
    ...
    {
        if(authorize(RolePermissionConstant::PERMISSION_GENRE_EDIT) || authorize(RolePermissionConstant::PERMISSION_GENRE_DELETE) || authorize(RolePermissionConstant::PERMISSION_GENRE_CHANGE_STATUS)){
