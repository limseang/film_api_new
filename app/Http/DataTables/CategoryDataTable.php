...
class CategoryDataTable extends DataTable
{
    ...
    {
        if(authorize(RolePermissionConstant::PERMISSION_CATEGORY_CHANGE_STATUS) || authorize(RolePermissionConstant::PERMISSION_CATEGORY_EDIT) || authorize(RolePermissionConstant::PERMISSION_CATEGORY_DELETE)){
